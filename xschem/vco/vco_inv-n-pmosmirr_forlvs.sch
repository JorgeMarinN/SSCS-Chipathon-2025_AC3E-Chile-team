...
N 350 -240 350 -150 {lab=#net1}
N 600 -240 600 -150 {lab=#net2}
N 570 -540 570 -490 { lab=#net3}
N 570 -540 600 -540 {lab=#net3}
N 570 -320 570 -270 { lab=#net2}
N 570 -270 600 -270 {lab=#net2}
...
N 600 -570 600 -540 {lab=#net3}
N 600 -270 600 -240 {lab=#net2}
...
C {devices/iopin.sym} 600 -650 3 0 {name=p4 lab=VDD}
C {symbols/pfet_05v0.sym} 370 -600 0 1 {name=MP2
L=4u
W=8u
nf=8
m=1
...
C {symbols/pfet_05v0.sym} 580 -600 0 0 {name=MP3
L=4u
W=5u
nf=5
m=1
